...
SPATULA_BASE_URDF = "spatula/spatula-base.urdf"
...
class Spatula(Gripper):
    ...
    def __init__(
        self, assets_root, robot, ee, obj_ids
...
class Suction(Gripper):
    ...
    def __init__(self, assets_root, robot, ee, obj_ids=None):
        ...
        pose = ((0.287, 0.239, 1.038), p.getQuaternionFromEuler((np.pi, 0, 0)))
        base = self.load_urdf(
        ...
        # base(-0.2, 0.13, 0.6)
        pose = ((0.287, 0.239, 0.947), p.getQuaternionFromEuler((np.pi, 0, 0)))
    ...
    def load_urdf(self, pybullet_client, file_path, *args, **kwargs):
