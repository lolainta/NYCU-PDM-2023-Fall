...
from envs.panda_envs.panda_push_gym_env_HER_Dynamics_Randomization import (
    pandaPushGymEnvHERRand,
)
...
def main(load_policy=False):
    ...
    if load_policy:
        log_dir_policy = (
            "../policies/PUSHING_TD3+HER_FIXED_POSITION_DYN_RAND_FROM_FIXED_PHYSICS"
        )
    ...
    model = HER(
        ...
        verbose=1,
        tensorboard_log="../pybullet_logs/panda_push_TD3/stable_baselines/TD3+HER_FIXED_DYN_RAND",
        buffer_size=1000000,
        batch_size=256,
