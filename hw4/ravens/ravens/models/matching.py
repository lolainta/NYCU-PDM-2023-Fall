...
class Matching:
    ...
    def __init__(
        self, input_shape, descriptor_dim, num_rotations, preprocess, lite=False
    ):
    ...
    def forward(self, input_image):
        ...
        input_tensor = tfa_image.transform(input_tensor, rvecs, interpolation="NEAREST")
    ...
    def train(self, input_image, p, q, theta):
        ...
        with tf.GradientTape() as tape:
            ...
            positive_loss = tfa_losses.contrastive_loss(
            ...
            for i in range(num_samples):
                descriptor = output[
                    inegative[i, 2], inegative[i, 0], inegative[i, 1], :
                ]
