...
class TransportHybrid6DoF(Transport):
    ...
    def train(self, in_img, p, q, theta, z, roll, pitch, backprop=True):
        ...
        with tf.GradientTape() as tape:
            ...
            z_est_at_xytheta = z_tensor[
                0, u_min:u_max, v_min:v_max, theta_min:theta_max
            ]
            roll_est_at_xytheta = roll_tensor[
                0, u_min:u_max, v_min:v_max, theta_min:theta_max
            ]
            pitch_est_at_xytheta = pitch_tensor[
                0, u_min:u_max, v_min:v_max, theta_min:theta_max
            ]
            ...
            roll_loss = roll_weight * self.regress_loss(roll_label, roll_est_at_xytheta)
